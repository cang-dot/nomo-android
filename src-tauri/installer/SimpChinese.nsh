...
LangString dontUninstallDowngrade ${LANG_SIMPCHINESE} "不卸载（此安装器不支持在不卸载的情况下降级）"
LangString failedToKillApp ${LANG_SIMPCHINESE} "无法结束 {{product_name}}。请先手动关闭它，然后重试。"
LangString installingWebview2 ${LANG_SIMPCHINESE} "正在安装 WebView2..."
LangString newerVersionInstalled ${LANG_SIMPCHINESE} "系统中已安装更新版本的 ${PRODUCTNAME}！不建议安装旧版本。如果确实要安装旧版本，建议先卸载当前版本。请选择要执行的操作，然后点击下一步继续。"
LangString older ${LANG_SIMPCHINESE} "旧"
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "系统中已安装一个 $R4 版本的 ${PRODUCTNAME}。建议先卸载当前版本再安装。请选择要执行的操作，然后点击下一步继续。"
LangString silentDowngrades ${LANG_SIMPCHINESE} "此安装器已禁用降级安装，静默安装无法继续。请改用图形界面安装器。$\n"
...
LangString webview2AbortError ${LANG_SIMPCHINESE} "WebView2 安装失败！应用缺少它将无法运行。请重启安装器后重试。"
...
LangString webview2InstallError ${LANG_SIMPCHINESE} "错误：WebView2 安装失败，退出码为 $1"
